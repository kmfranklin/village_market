...
if (is_post_request()) {
  ...
  // Clear previous attendance for this vendor
  MarketAttendance::delete_all_for_vendor($vendor->vendor_id);

  // Reinsert each selected date
  foreach ($submitted_dates as $market_date_id) {
    ...
    $attendance->attendance_id = null; // Ensure insert
...
// Load upcoming market dates and saved selections
